...
// on Saturday, 08-Jan-2022 20:15:57 EST// $Id: TableClass.php 16 2012-03-09 10:09:43Z scott_auge $
//
...
class clsclient extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO client (ClientRecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM client WHERE ClientRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $this->ClientRecID);
    $S->execute();
    $S->close();
  ...
  public function Update () {
    ...
    $SQL = "UPDATE client SET Name = ? WHERE ClientRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ss", $this->Name,$this->ClientRecID);
    $S->execute();
    $S->close();
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT ClientRecID, Name FROM client WHERE ClientRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->ClientRecID, $this->Name);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT ClientRecID, Name FROM " . $SQL;
    ...
    $this->_S->bind_result($this->ClientRecID, $this->Name);
