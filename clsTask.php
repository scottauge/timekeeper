...
// on Saturday, 08-Jan-2022 20:31:12 EST// $Id: TableClass.php 16 2012-03-09 10:09:43Z scott_auge $
//
...
class clstask extends clsUtil {
  ...
  public function FindByID ($ID) {
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->TaskRecID, $this->Name);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT TaskRecID, Name FROM " . $SQL;
    ...
    $this->_S->bind_result($this->TaskRecID, $this->Name);
