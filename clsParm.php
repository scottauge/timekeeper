...
// on Saturday, 08-Jan-2022 20:27:32 EST// $Id: TableClass.php 16 2012-03-09 10:09:43Z scott_auge $
//
...
class clsparm extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO parm (ParmRecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM parm WHERE ParmRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $this->ParmRecID);
    $S->execute();
    $S->close();
  ...
  public function Update () {
    ...
    //
          ...
          $this->ParmRecID = stripslashes($this->ParmRecID);
    ...
    $SQL = "UPDATE parm SET Name = ?, Value = ? WHERE ParmRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("sss", $this->Name, $this->Value,$this->ParmRecID);
    $S->execute();
    $S->close();
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT ParmRecID, Name, Value FROM parm WHERE ParmRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->ParmRecID, $this->Name, $this->Value);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT ParmRecID, Name, Value FROM " . $SQL;
    ...
    $this->_S->bind_result($this->ParmRecID, $this->Name, $this->Value);
