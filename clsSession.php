...
// on Saturday, 08-Jan-2022 20:30:01 EST// $Id: TableClass.php 16 2012-03-09 10:09:43Z scott_auge $
//
...
class clssession extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO session (SessionRecID) VALUES (?)";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    $S->execute();
    $S->close();
    $this->SessionRecID = $ID;
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM session WHERE SessionRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $this->SessionRecID);
    $S->execute();
    $S->close();
  ...
  public function Update () {
    ...
    //
          ...
          $this->SessionRecID = stripslashes($this->SessionRecID);
      $this->Cookie = stripslashes($this->Cookie);
      $this->UserRecID = stripslashes($this->UserRecID);
      $this->LastUsed = stripslashes($this->LastUsed);
    ...
    $SQL = "UPDATE session SET Cookie = ?, UserRecID = ?, LastUsed = ? WHERE SessionRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ssss", $this->Cookie, $this->UserRecID, $this->LastUsed,$this->SessionRecID);
    $S->execute();
    $S->close();
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT SessionRecID, Cookie, UserRecID, LastUsed FROM session WHERE SessionRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->SessionRecID, $this->Cookie, $this->UserRecID, $this->LastUsed);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT SessionRecID, Cookie, UserRecID, LastUsed FROM " . $SQL;
    ...
    $this->_S->bind_result($this->SessionRecID, $this->Cookie, $this->UserRecID, $this->LastUsed);
