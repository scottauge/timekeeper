...
// on Thursday, 10-Feb-2022 15:15:56 EST// $Id: TableClass.php 16 2012-03-09 10:09:43Z scott_auge $
//
...
class clslogins extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO logins (UserRecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM logins WHERE UserRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    $SQL = "UPDATE logins SET FirstName = ?, LastName = ?, Password = ?, UserID = ? WHERE UserRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT UserRecID, FirstName, LastName, Password, UserID FROM logins WHERE UserRecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
